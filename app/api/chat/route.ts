...
function getSystemMessage(role : string){
  switch (role) {
    ...
    case 'general_physician':
      ...
      break;
    default:
    systemMessageContent = "Respond with: 'If you're seeing this message, you have encountered an error. Please contact the developer and tell them ROLE_NOT_SET.'";
      break;
  }
}
